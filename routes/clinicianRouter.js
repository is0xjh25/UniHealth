...
clinicianRouter.get(
    '/dashboard',
    utilities.isLoggedInClinician,
    clinicianController.dashboard
)
...
clinicianRouter.get(
    ...
    utilities.isLoggedInClinician,
    clinicianController.patientInfo
)
...
clinicianRouter.get(
    '/add-patient',
    utilities.isLoggedInClinician,
    clinicianController.newPatient
)
...
clinicianRouter.post(
    '/note/:patientID',
    utilities.isLoggedInClinician,
    clinicianController.newNote
)

// edit patient's supporting message ***
clinicianRouter.post(
    '/support-message/:patientID',
    utilities.isLoggedInClinician,
...
clinicianRouter.post(
    '/patient-management',
    utilities.isLoggedInClinician,
    clinicianController.patientManagement
)
...
clinicianRouter.post(
    '/add-patient',
    utilities.isLoggedInClinician,
    clinicianController.addPatient
)
